...
!(function () {
    ...
    const x = (e, t) => {
        ...
        M = (e) => {
            ...
            else for (let i = Math.max(n - t, 0); i <= Math.min(n + t, s - 1); i += 1) i !== r && i > n && C(e, i);
        };
    var P = {
        updateSize: function () {
            const e = this;
        ...
        updateSlides: function () {
            ...
            const z = "auto" === i.slidesPerView && i.breakpoints && Object.keys(i.breakpoints).filter((e) => void 0 !== i.breakpoints[e].slidesPerView).length > 0;
            for (let r = 0; r < h; r += 1) {
                let n;
                if (((k = 0), p[r] && (n = p[r]), P && e.grid.updateSlide(r, n, h, t), !p[r] || "none" !== m(n, "display"))) {
                    if ("auto" === i.slidesPerView) {
                        z && (p[r].style[t("width")] = "");
                        const a = getComputedStyle(n),
                            o = n.style.transform,
                            l = n.style.webkitTransform;
                        if ((o && (n.style.transform = "none"), l && (n.style.webkitTransform = "none"), i.roundLengths)) k = e.isHorizontal() ? g(n, "width", !0) : g(n, "height", !0);
                        else {
                            const e = s(a, "width"),
                                t = s(a, "padding-left"),
                                i = s(a, "padding-right"),
                    ...
                    } else (k = (a - (i.slidesPerView - 1) * y) / i.slidesPerView), i.roundLengths && (k = Math.floor(k)), p[r] && (p[r].style[t("width")] = `${k}px`);
                    p[r] && (p[r].swiperSlideSize = k),
                        ...
                        i.centeredSlides
                            ? ((x = x + k / 2 + C / 2 + y),
                              ...
                              w.push(x))
                            : (i.roundLengths && (x = Math.floor(x)), (M - Math.min(e.params.slidesPerGroupSkip, M)) % e.params.slidesPerGroup == 0 && v.push(x), w.push(x), (x = x + k + y)),
                        (e.virtualSize += k + y),
                        (C = k),
                        (M += 1);
                }
            ...
            if (
                ...
                o && l && ("slide" === i.effect || "coverflow" === i.effect) && (r.style.width = `${e.virtualSize + y}px`),
            ...
            if (d && i.loop) {
                ...
                for (let s = 0; s < e.virtual.slidesBefore + e.virtual.slidesAfter; s += 1) 1 === i.slidesPerGroup && v.push(v[v.length - 1] + t), w.push(w[w.length - 1] + t), (e.virtualSize += t);
            }
            ...
            if ((Object.assign(e, { slides: p, snapGrid: v, slidesGrid: w, slidesSizesGrid: A }), i.centeredSlides && i.cssMode && !i.centeredSlidesBounds)) {
                u(r, "--swiper-centered-offset-before", -v[0] + "px"), u(r, "--swiper-centered-offset-after", e.size / 2 - A[A.length - 1] / 2 + "px");
            ...
            if (
                ...
                v.length !== T && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")),
        ...
        updateSlidesProgress: function (e) {
            ...
            for (let e = 0; e < i.length; e += 1) {
                ...
                ((u >= 0 && u < t.size - 1) || (h > 1 && h <= t.size) || (u <= 0 && h >= t.size)) && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e), i[e].classList.add(s.slideVisibleClass)),
                    (l.progress = r ? -c : c),
        ...
        updateActiveIndex: function (e) {
            ...
            (p = t.virtual && r.virtual.enabled && r.loop ? c(d) : t.slides[d] ? parseInt(t.slides[d].getAttribute("data-swiper-slide-index") || d, 10) : d),
                Object.assign(t, { previousSnapIndex: o, snapIndex: l, previousRealIndex: a, realIndex: p, previousIndex: n, activeIndex: d }),
                t.initialized && M(t),
        ...
        setTranslate: function (e, t) {
            ...
            s.isHorizontal() ? (l = i ? -e : e) : (d = e),
                ...
                r.cssMode
                    ...
                    : r.virtualTranslate || (s.isHorizontal() ? (l -= s.cssOverflowAdjustment()) : (d -= s.cssOverflowAdjustment()), (n.style.transform = `translate3d(${l}px, ${d}px, 0px)`));
        ...
        translateTo: function (e, t, s, i, r) {
            ...
            if (((c = i && e > l ? l : i && e < d ? d : e), n.updateProgress(c), a.cssMode)) {
                ...
                if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
                    ...
                    if (!n.support.smoothScroll) return h({ swiper: n, targetPosition: -c, side: e ? "left" : "top" }), !0;
    ...
    var L = {
        slideTo: function (e, t, s, i, r) {
            ...
            let a = e;
            a < 0 && (a = 0);
            const { params: o, snapGrid: l, slidesGrid: d, previousIndex: c, activeIndex: p, rtlTranslate: u, wrapperEl: f, enabled: m } = n;
            ...
            let A;
            if ((a !== (c || 0) && s && n.emit("beforeSlideChangeStart"), n.updateProgress(w), (A = a > p ? "next" : a < p ? "prev" : "reset"), (u && -w === n.translate) || (!u && w === n.translate)))
                return n.updateActiveIndex(a), o.autoHeight && n.updateAutoHeight(), n.updateSlidesClasses(), "slide" !== o.effect && n.setTranslate(w), "reset" !== A && (n.transitionStart(s, A), n.transitionEnd(s, A)), !1;
            if (o.cssMode) {
                const e = n.isHorizontal(),
                    s = u ? w : -w;
                if (0 === t) {
                    ...
                    if (!n.support.smoothScroll) return h({ swiper: n, targetPosition: s, side: e ? "left" : "top" }), !0;
                      ...
                      n.onSlideToWrapperTransitionEnd ||
                          (n.onSlideToWrapperTransitionEnd = function (e) {
                              n &&
                                  !n.destroyed &&
                                  e.target === this &&
                                  (n.wrapperEl.removeEventListener("transitionend", n.onSlideToWrapperTransitionEnd), (n.onSlideToWrapperTransitionEnd = null), delete n.onSlideToWrapperTransitionEnd, n.transitionEnd(s, A));
                          }),
        ...
        slidePrev: function (e, t, s) {
            ...
            if (
                (void 0 !== f &&
                    ((m = a.indexOf(f)), m < 0 && (m = i.activeIndex - 1), "auto" === r.slidesPerView && 1 === r.slidesPerGroup && r.slidesPerGroupAuto && ((m = m - i.slidesPerViewDynamic("previous", !0) + 1), (m = Math.max(m, 0)))),
            ...
            if (
                ...
                if (v.length > 0 && b)
                    if (void 0 === t) {
                        ...
                        o ? l.setTranslate(l.translate - t) : (l.slideTo(w + S, 0, !1, !0), r && (l.touches[l.isHorizontal() ? "startX" : "startY"] += t));
                    } else r && l.slideToLoop(t, 0, !1, !0);
                else if (g.length > 0 && A)
                    if (void 0 === t) {
                        const e = l.slidesGrid[w],
                            t = l.slidesGrid[w - T] - e;
                        o ? l.setTranslate(l.translate - t) : (l.slideTo(w - T, 0, !1, !0), r && (l.touches[l.isHorizontal() ? "startX" : "startY"] += t));
                    } else l.slideToLoop(t, 0, !1, !0);
            if (((l.allowSlidePrev = c), (l.allowSlideNext = p), l.controller && l.controller.control && !a)) {
                const e = { slideRealIndex: t, slideTo: !1, direction: i, setTranslate: r, activeSlideIndex: n, byController: !0 };
    ...
    function I(e) {
        ...
        (!l.touchStartForcePreventDefault && !T) || u.isContentEditable || p.preventDefault(), t.params.freeMode && t.params.freeMode.enabled && t.freeMode && t.animating && !l.cssMode && t.freeMode.onTouchStart(), t.emit("touchStart", p);
    }
    function G(e) {
        const t = i(),
            s = this,
        ...
        if (!s.allowTouchMove)
            return (
                ...
                void (r.isTouched && (Object.assign(a, { startX: h, startY: f, prevX: s.touches.currentX, prevY: s.touches.currentY, currentX: h, currentY: f }), (r.touchStartTime = o())))
            );
        ...
        if (void 0 === r.isScrolling) {
            ...
            (s.isHorizontal() && a.currentY === a.startY) || (s.isVertical() && a.currentX === a.startX)
                ? (r.isScrolling = !1)
                : m * m + v * v >= 25 && ((e = (180 * Math.atan2(Math.abs(v), Math.abs(m))) / Math.PI), (r.isScrolling = s.isHorizontal() ? e > n.touchAngle : 90 - e > n.touchAngle));
        }
        if (
        ...
        if (!r.isMoved) {
            if ((b && s.loopFix({ direction: s.swipeDirection }), (r.startTranslate = s.getTranslate()), s.setTransition(0), s.animating)) {
        ...
        let S;
        r.isMoved && A !== s.touchesDirection && b && Math.abs(g) >= 1 && (s.loopFix({ direction: s.swipeDirection, setTranslate: !0 }), (S = !0)), s.emit("sliderMove", c), (r.isMoved = !0), (r.currentTranslate = g + r.startTranslate);
        let T = !0,
            E = n.resistanceRatio;
        if (
            (n.touchReleaseOnEdges && (E = 0),
            g > 0
                ? (b && !S && r.currentTranslate > (n.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({ direction: "prev", setTranslate: !0, activeSlideIndex: 0 }),
                  r.currentTranslate > s.minTranslate() && ((T = !1), n.resistance && (r.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + r.startTranslate + g) ** E)))
                : g < 0 &&
                  (b &&
                      !S &&
                  ...
                  r.currentTranslate < s.maxTranslate() && ((T = !1), n.resistance && (r.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - r.startTranslate - g) ** E))),
    ...
    function _(e) {
        ...
        const { params: r, touches: n, rtlTranslate: l, slidesGrid: d, enabled: c } = t;
        if (!c) return;
        ...
        if (h > r.longSwipesMs) {
            ...
            "next" === t.swipeDirection && (A >= r.longSwipesRatio ? t.slideTo(r.rewind && t.isEnd ? g : m + b) : t.slideTo(m)),
                "prev" === t.swipeDirection && (A > 1 - r.longSwipesRatio ? t.slideTo(m + b) : null !== w && A < 0 && Math.abs(A) > r.longSwipesRatio ? t.slideTo(w) : t.slideTo(m));
        } else {
            ...
            t.navigation && (p.target === t.navigation.nextEl || p.target === t.navigation.prevEl)
                ? p.target === t.navigation.nextEl
                    ? t.slideTo(m + b)
                    : t.slideTo(m)
                : ("next" === t.swipeDirection && t.slideTo(null !== g ? g : m + b), "prev" === t.swipeDirection && t.slideTo(null !== w ? w : m));
        }
    }
    function B() {
        const e = this,
    ...
    const V = (e, t) => {
        ...
        n[d]("pointerdown", e.onTouchStart, { passive: !1 }),
            ...
            r.updateOnWindowResize ? e[c](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", B, !0) : e[c]("observerUpdate", B, !0),
        ...
        return function (s) {
            ...
            "object" == typeof r && null !== r
                ? (["navigation", "pagination", "scrollbar"].indexOf(i) >= 0 && !0 === e[i] && (e[i] = { auto: !0 }),
                  i in e && "enabled" in r ? (!0 === e[i] && (e[i] = { enabled: !0 }), "object" != typeof e[i] || "enabled" in e[i] || (e[i].enabled = !0), e[i] || (e[i] = { enabled: !1 }), p(t, s)) : p(t, s))
                : p(t, s);
        };
    }
    const $ = {
    ...
    class q {
        constructor() {
            ...
            const l = {};
            o.modules.forEach((e) => {
                e({ params: t, swiper: o, extendParams: W(t, l), on: o.on.bind(o), once: o.once.bind(o), off: o.off.bind(o), emit: o.emit.bind(o) });
            });
            const d = p({}, R, l);
            return (
                (o.params = p({}, d, X, t)),
    ...
    function U(e, t) {
        ...
        Object.keys(t)
            ...
            .forEach((s) => {
                void 0 === e[s] ? (e[s] = t[s]) : Z(t[s]) && Z(e[s]) && Object.keys(t[s]).length > 0 ? (t[s].__swiper__ ? (e[s] = t[s]) : U(e[s], t[s])) : (e[s] = t[s]);
            });
    }
    function K(e) {
        return void 0 === e && (e = ""), e.replace(/-[a-z]/g, (e) => e.toUpperCase().replace("-", ""));
    }
    const J = (e) => (parseFloat(e) === Number(e) ? Number(e) : "true" === e || "" === e || ("false" !== e && ("null" === e ? null : "undefined" !== e ? e : void 0))),
        ee = [
            "a11y",
            "autoplay",
            "controller",
        ...
        return (
            ...
            o.forEach((e) => {
                ...
                if (t) {
                    ...
                    void 0 === r[s] && (r[s] = {}), !0 === r[s] && (r[s] = { enabled: !0 }), (r[s][i] = J(e.value));
                } else {
                    const t = K(e.name);
                    if (!a.includes(t)) return;
                    const s = J(e.value);
                    r[t] && ee.includes(e.name) ? (r[t].constructor !== Object && (r[t] = {}), (r[t].enabled = s)) : (r[t] = s);
                }
            }),
            U(i, r),
    ...
    const re = (e, t) => {
        ...
        !e &&
            ...
            (s && !i) || ((s = s || document.createElement("style")), (s.textContent = [se, t ? t.cssStyles() : ""].join("\n")), (s.id = "swiper-element-styles"), (s.preInit = e), document.head.prepend(s));
    };
    const ne = "undefined" == typeof window || "undefined" == typeof HTMLElement ? class {} : HTMLElement;
    class ae extends ne {
        constructor() {
            ...
            (this.swiperParams = t),
                ...
                (this.swiper = new q(this, {
                    ...
                    onAny: function (s) {
                        ...
                        const o = new CustomEvent(i, { detail: n, bubbles: !0, cancelable: !0 });
                        e.dispatchEvent(o);
                    },
                }));
        }
        connectedCallback() {
            (this.initialized && this.nested && this.closest("swiper-slide") && this.closest("swiper-slide").swiperLoopMoveDOM) || (!1 !== this.init && "false" !== this.getAttribute("init") ? this.initialize() : re(!0, this));
        }
        ...
        updateSwiperOnPropChange(e, t) {
            ...
            (this.passedParams = i),
                (this.swiperParams = s),
                (function (e) {
                    let { swiper: t, slides: s, passedParams: i, changedParams: r, nextEl: n, prevEl: a, scrollbarEl: o, paginationEl: l } = e;
                    const d = r.filter((e) => "children" !== e && "direction" !== e && "wrapperClass" !== e),
                        { params: c, pagination: p, navigation: u, scrollbar: h, virtual: f, thumbs: m } = t;
                    let v, g, w, A, b, S, T, E;
                    r.includes("thumbs") && i.thumbs && i.thumbs.swiper && c.thumbs && !c.thumbs.swiper && (v = !0),
                        r.includes("controller") && i.controller && i.controller.control && c.controller && !c.controller.control && (g = !0),
                        r.includes("pagination") && i.pagination && (i.pagination.el || l) && (c.pagination || !1 === c.pagination) && p && !p.el && (w = !0),
                        r.includes("scrollbar") && i.scrollbar && (i.scrollbar.el || o) && (c.scrollbar || !1 === c.scrollbar) && h && !h.el && (A = !0),
                        r.includes("navigation") && i.navigation && (i.navigation.prevEl || a) && (i.navigation.nextEl || n) && (c.navigation || !1 === c.navigation) && u && !u.prevEl && !u.nextEl && (b = !0);
                    const y = (e) => {
                        t[e] &&
                            (t[e].destroy(),
                            "navigation" === e
                    ...
                    r.includes("loop") && t.isElement && (c.loop && !i.loop ? (S = !0) : !c.loop && i.loop ? (T = !0) : (E = !0)),
                        d.forEach((e) => {
                            if (Z(c[e]) && Z(i[e])) U(c[e], i[e]), ("navigation" !== e && "pagination" !== e && "scrollbar" !== e) || !("enabled" in i[e]) || i[e].enabled || y(e);
                            else {
                                const t = i[e];
                        ...
                        r.includes("children") && s && f && c.virtual.enabled && ((f.slides = s), f.update(!0)),
                        r.includes("children") && s && c.loop && (E = !0),
                        v && m.init() && m.update(!0);
                    g && (t.controller.control = c.controller.control),
                        w &&
                            (!t.isElement || (l && "string" != typeof l) || ((l = document.createElement("div")), l.classList.add("swiper-pagination"), t.el.shadowEl.appendChild(l)),
                            l && (c.pagination.el = l),
                            p.init(),
                            p.render(),
                            p.update()),
                        A &&
                            (!t.isElement || (o && "string" != typeof o) || ((o = document.createElement("div")), o.classList.add("swiper-scrollbar"), t.el.shadowEl.appendChild(o)),
                            o && (c.scrollbar.el = o),
                            h.init(),
                            h.updateSize(),
                            h.setTranslate()),
                        b &&
                            (t.isElement &&
                                ((n && "string" != typeof n) || ((n = document.createElement("div")), n.classList.add("swiper-button-next"), t.el.shadowEl.appendChild(n)),
                                (a && "string" != typeof a) || ((a = document.createElement("div")), a.classList.add("swiper-button-prev"), t.el.shadowEl.appendChild(a))),
    ...
    "undefined" != typeof window &&
        ...
        "undefined" != typeof window &&
            ...
            window.customElements.get("swiper-slide") || window.customElements.define("swiper-slide", oe));
})();
